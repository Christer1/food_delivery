...
class PopularProductController extends GetxController{
  ...
  void setQuantity(bool isIncrement){
    if(isIncrement){
      ...
      // print("Increament of " +_quantity.toString());
    }else{
      _quantity = checkQuantity(_quantity - 1);
      // print("Increament of " +_quantity.toString());
    }
  ...
  int checkQuantity(int quantity){
    if((_inCartItems + quantity) < 0){
      ...
      CustomSnackbar.showSnackbar("Item count", "You can't reduce more!");
      ...
      CustomSnackbar.showSnackbar("Item count", "You can't add more!");
      return 20;
    }else{
      return quantity;
    }
  ...
  void addItem(ProductModel product){
      ...
      _cart.items.forEach((key, value) {
        print("Thie id is " + value.id.toString()+" and the quantity is " + value.quantity.toString());
      });
    update();
  }
